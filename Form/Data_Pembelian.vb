Public Class Data_Pembelian
    ...
    Private Sub TambahKeranjang()
        ...
        Dim sql As String = "INSERT INTO detail_pembelian (no_nota, kode_barang, harga_barang, sub_total, jumlah, diskon) VALUES ('" & no_nota & "', '" & kode_barang & "', '" & harga_barang & "', '" & sub_total & "', '" & jumlah & "', '" & diskon & "')"
